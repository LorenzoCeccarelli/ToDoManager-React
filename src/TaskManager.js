...
const iconDelete=<button type="button" className="btn"><svg className="bi bi-trash" width="1em" height="1em" viewBox="0 0 16 16" fill="currentColor" xmlns="http://www.w3.org/2000/svg">
...
function NewTaskButton(){
    return <button id="newTaskButton" type="button" className="btn btn-lg btn-success fixed-right-bottom" data-toggle="modal" data-target="#staticBackdrop">&#43;</button>;
}
